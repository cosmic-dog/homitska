...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	$image_url = get_the_post_thumbnail_url( get_the_ID(), 'twentytwenty-fullscreen' );
	...
	<div class="post-inner" id="post-inner">
		...
		wp_link_pages(
			array(
				'before'      => '<nav class="post-nav-links bg-light-background" aria-label="' . esc_attr__($cover_header_classes = ' bg-image';
